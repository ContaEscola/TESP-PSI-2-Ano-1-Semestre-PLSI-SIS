...
<section class="container padding-block-700" data-type="small-md">
    ...
    <button class=" [ button ] [ d-block margin-top-400 push-to-right ]" data-type="primary-outline">Novo
        Ticket</button>

    <div class="margin-top-100">
        <!-- Se ainda não tiver nenhum bilhete -->
        <!-- <p class="fw-medium text-align-center"> Você ainda não fez nenhum ticket!</p> -->
        ...
        <dialog class="[ support-ticket-modal ] [ modal container padding-300 ]" data-type="very-small-md"
            ...
            <?= ListView::widget([
                ...
                'emptyText' => "<p class='fw-medium text-align-center'> Você ainda não tem nenhum suporte ticket!</p>",
                'itemView' => '_ticket',
            ]); ?>
    </div>
